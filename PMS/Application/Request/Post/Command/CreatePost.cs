...
{
    public class CreatePost : IRequest<Result>
    {
        ...
        public CreatePost(int categoryId, string title, string description, string featuredImage, string image, string tags) 
        { 
    ...
    public class CreatePostHandler : IRequestHandler<CreatePost, Result>
    {
        ...
        public CreatePostHandler(IPostService _postService)
        {
