...
namespace PMS.Application.Request.Sales
{
    ...
    {
        Task<IEnumerable<DownloadSalesReportViewModel>> DownloadSalesReport(DownloadSalesReport request);
        ...
        Task<IEnumerable<QuantityWiseSalesReportViewModel>> QuantityWiseSalesReport(QuantityWiseSalesReport request);
